...
if __name__ == '__main__':
    ...
    with open(os.path.join(args.work_dir, args.input_file)) as fin:
        lines = fin.readlines()
    ...
    task_clf_types = {}
    with open(os.path.join(args.work_dir, "is_clf_or_not_template_1.jsonl")) as fin:
        for line in fin:
            data = json.loads(line)
    ...
    output_path = os.path.join(args.work_dir, args.output_file)
    existing_requests = {}

...
def encode_prompt(prompt_instructions, classification=False):
    ...
    Args:
        prompt_instructions (list): List of instruction strings to encode
        classification (bool): If True, generate classification-specific prompt
        
    Returns:
        str: Combined prompt string with numbered instructions
    """
    if classification:
...
def sample_machine_instructions(machine_instructions, similarities, n):
    ...
    Args:
        machine_instructions (list): List of machine-generated instructions
        similarities (dict): Dictionary of instruction similarities (unused)
        n (int): Number of instructions to sample
        
    Returns:
        list: Randomly sampled subset of machine instructions
    """
...
def find_word_in_string(w, s):
    """
    Search for whole word match in string.
    
    Args:
        w (str): Word to search for
        s (str): String to search in
        
    Returns:
        re.Match object or None: Match object if word is found, None otherwise
    """
...
def post_process_response(response):
    """
    Process raw GPT response into cleaned instruction list.
    
    Args:
        response (dict): Raw response from GPT API
        
    Returns:
        list: Cleaned and filtered list of instructions
        
    Notes:
        - Filters out instructions that are too short/long
        - Removes instructions with forbidden keywords
        - Cleans formatting and capitalization
    """
